...
void Update_Buzzer(int distance) {
    int i;
    if (distance < 5) {
        for (i = 0; i < 100; i++) {  // Daha yüksek frekans
            BUZZER = 1;
            __delay_us(500);
            BUZZER = 0;
            __delay_us(500);
        ...
        for (i = 0; i < 25; i++) {  // Daha dü?ük frekans
            BUZZER = 1;
            __delay_ms(5);
            BUZZER = 0;
            __delay_ms(5);
        ...
        for (i = 0; i < 10; i++) {  // En dü?ük frekans
            BUZZER = 1;
            __delay_ms(10);
            BUZZER = 0;
            __delay_ms(10);
